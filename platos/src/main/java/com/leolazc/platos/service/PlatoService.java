...
import com.leolazc.platos.dto.IngredienteDTO;
import com.leolazc.platos.model.Plato;
import com.leolazc.platos.repository.IPlatoRepository;
...
public class PlatoService implements IPlatoService {
    ...
    public void savePlato(String nombre, Double precio, String descripcion) {
        ...
        List<IngredienteDTO> listaIngredientes = Arrays.asList(api.getForObject("http://localhost:9005/ingredientes/traer/" + nombre, IngredienteDTO[].class));
